...
def extract_fields_with_openai(text, model="gpt-3.5-turbo", service_type="matricula"):
    ...
    try:
        ...
        # --- NOVO TRATAMENTO PARA BLOCO DE CÓDIGO MARKDOWN ---
        ...
        try:
            ...
            print(f"📄 Conteúdo recebido: {content_clean[:200]}...")
            return {"error": f"Erro ao interpretar resposta da OpenAI: {str(e)}", "raw": content_clean}
